...
import com.onlinebookreader.dto.ForgotPasswordDTO;
import com.onlinebookreader.dto.LoginRequest;
import com.onlinebookreader.dto.RefreshTokenRequest;
import com.onlinebookreader.dto.ResetPasswordDTO;
import com.onlinebookreader.dto.TokenResponse;
...
import com.onlinebookreader.service.PasswordResetService;
...
//			}
	...
	public ResponseEntity<?> forgotPassword(@RequestBody ForgotPasswordDTO request) {
		...
		return ResponseEntity.ok("If an account exists, a password reset email has been sent.");
	}

	@PostMapping("/reset-password")
	public ResponseEntity<String> resetPassword(@RequestBody ResetPasswordDTO request) {

		passwordResetService.resetPassword(request.getToken(), request.getNewPaasword());
